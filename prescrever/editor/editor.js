...
function normalizeRepoSubPath(value, fallback = "data") {
...
function loadStoredGithubConfig() {
  try {
    ...
    return {
      ...
      dataPath: normalizeRepoSubPath(parsed?.dataPath, "data")
    };
  } catch (_error) {
    return {
      owner: "",
  ...
  try {
    localStorage.setItem(
      ...
      JSON.stringify({
        ...
        dataPath: normalizeRepoSubPath(config?.dataPath, "data")
      })
    );
  } catch (_error) {}
}
...
function applyGithubConfigToInputs(config) {
  ...
  dom.ghDataPath.value = normalizeRepoSubPath(config?.dataPath, "data");
}
...
function getGithubConfigFromInputs() {
  return {
    ...
    dataPath: normalizeRepoSubPath(dom.ghDataPath?.value, "data"),
