const SCENARIOS = [
  {
    ...
    observacao: "Roteiro ACLS deterministico. Referencias [1], [1-2] ficam internas.",
    resumo:
      "Bradicardia instavel com segunda linha, transicao para PCR chocavel, AESP e pos-RCE.",
    paciente: {
      apresentacao: "Paciente consciente, mas confuso no inicio.",
    ...
    steps: [
      {
        ...
        tipo: "inicio",
        texto_instrutor:
          "Paciente consciente, mas confuso. FC 38 bpm. PA 78/50. SpO2 88% AA.",
        respostas_esperadas: [
          "Verbalizar: bradicardia sintomatica instavel",
          "Iniciar O2",
          "Checar eletrodos",
          "Garantir acesso IV",
      ...
      },
      {
        ...
        tipo: "oxigenacao",
        texto_instrutor:
          "Depois: O2 15 L/min NRB, SpO2 96%, mantem hipotenso/confuso.",
        respostas_esperadas: [
          "Manter monitorizacao continua",
          "Reavaliar perfusao e estado mental"
        ],
      ...
      },
      {
        ...
        tipo: "atropina",
        texto_instrutor:
          "Dose 1: atropina 1 mg IV bolus, aguardar 3-5 min. Apos 3 min: FC 40, PA 80/52, confuso.",
        respostas_esperadas: [
          "Administrar atropina 1 mg IV bolus",
          "Aguardar 3-5 min",
      ...
      },
      {
        ...
        tipo: "atropina",
        texto_instrutor:
          "Dose 2: atropina 1 mg. Apos 3 min: FC 42, PA 82/50.",
        respostas_esperadas: [
      ...
      },
      {
        ...
        tipo: "atropina",
        texto_instrutor:
          "Dose 3: atropina 1 mg (ultima). Apos 3 min: FC 38, PA 76/48, piora.",
        respostas_esperadas: [
          "Administrar atropina 1 mg (ultima)",
      ...
      },
      {
        ...
        tipo: "segunda_linha",
        texto_instrutor:
          "Escolha A: marcapasso transcutaneo (pas, 60-80 bpm, subir mA ate captura, confirmar pulso, considerar sedacao) OU Escolha B: dopamina 5-20 mcg/kg/min (iniciar 5 e titular).",
        respostas_esperadas: ["Definir estrategia de segunda linha (A ou B)"],
        vitals: { fc: 38, pa: "76/48", spo2: 96, etco2: null, pulso: true },
        waveform: "sinus_bradicardia",
        ecg_image: "/assets/ecg/cenario1_bradicardia.png",
        branch: {
          default_choice: "A",
          prompt:
            "Selecione a conduta de segunda linha. Se nada for marcado, segue opcao A.",
          choices: [
            {
              value: "A",
              label:
                "Opcao A: marcapasso transcutaneo (60-80 bpm, subir mA ate captura, confirmar pulso, considerar sedacao).",
              next: "c1_s07a"
            },
            {
              value: "B",
              label:
                "Opcao B: dopamina 5-20 mcg/kg/min (iniciar 5 e titular).",
              next: "c1_s07b"
            }
          ]
        }
      },
      {
        ...
        texto_instrutor:
          "Escolha A: marcapasso transcutaneo (pas, 60-80 bpm, subir mA ate captura, confirmar pulso, considerar sedacao).",
        respostas_esperadas: [
          "Posicionar pas",
          "Ajustar 60-80 bpm",
          "Subir mA ate captura",
          "Confirmar pulso",
          "Considerar sedacao"
        ],
      ...
      },
      {
        ...
        texto_instrutor:
          "Escolha B: dopamina 5-20 mcg/kg/min (iniciar 5 e titular).",
        respostas_esperadas: [
          "Iniciar dopamina 5 mcg/kg/min",
          "Titular ate resposta"
        ],
        vitals: { fc: 42, pa: "82/50", spo2: 96, etco2: null, pulso: true },
        waveform: "sinus_bradicardia",
        ecg_image: "/assets/ecg/cenario1_bradicardia.png",
      ...
      },
      {
        ...
        tipo: "pcr_chocavel",
        texto_instrutor:
          "Instrutor: perde consciencia. Monitor: TV monomorfica. Sem pulso carotideo. Entrar em algoritmo chocavel: iniciar RCP HQ, delegar funcoes, preparar desfibrilador 200J bifasico.",
        respostas_esperadas: [
          "Reconhecer TV sem pulso",
          "Iniciar RCP HQ",
          "Delegar funcoes",
          "Preparar desfibrilador 200J bifasico"
        ],
      ...
      },
      {
        ...
        tipo: "choque",
        texto_instrutor:
          "Choque 1: analise rapida, choque, retomar RCP imediatamente. Via aerea: 30:2 ate via aerea avancada. Apos IOT: compressoes continuas + ventilacoes 10/min. ETCO2 12 inicial.",
        respostas_esperadas: [
          "Choque 1",
          "Retomar RCP imediatamente",
          "30:2 ate via aerea avancada",
          "Apos IOT: compressao continua + 10 ventilacoes/min"
        ],
        vitals: { fc: 180, pa: "0/0", spo2: "-", etco2: 12, pulso: false },
        waveform: "tv_monomorfica",
        evento: "SEM PULSO",
      ...
      },
      {
        ...
        tipo: "analise",
        texto_instrutor:
          "Analise 2 min: TV sem pulso. Choque 2 + epinefrina 1 mg.",
        respostas_esperadas: ["Choque 2", "Epinefrina 1 mg"],
      ...
      },
      {
        ...
        tipo: "analise",
        texto_instrutor:
          "Analise 4 min: TV sem pulso. Choque 3 + amiodarona 300 mg + troca compressor.",
        respostas_esperadas: ["Choque 3", "Amiodarona 300 mg", "Troca compressor"],
      ...
      },
      {
        ...
        tipo: "analise",
        texto_instrutor:
          "Analise 6 min: TV sem pulso. Choque 4 + epinefrina.",
        respostas_esperadas: ["Choque 4", "Epinefrina"],
      ...
      },
      {
        ...
        tipo: "aesp",
        texto_instrutor:
          "Analise 8 min: ritmo organizado ~70, SEM pulso => AESP. Retomar RCP, sem choque. Hs e Ts. Epinefrina (3a dose) no timing adequado. Analise 10 min: AESP persiste.",
        respostas_esperadas: [
          "Reconhecer AESP",
          "Retomar RCP sem choque",
          "Investigar Hs e Ts",
          "Aplicar epinefrina (3a dose)"
        ],
      ...
      },
      {
        ...
        tipo: "rce",
        texto_instrutor:
          "Analise 12 min: movimento, ETCO2 42, pulso presente => RCE.",
        respostas_esperadas: ["Reconhecer retorno da circulacao espontanea (RCE)"],
      ...
      },
      {
        ...
        tipo: "pos_rce",
        texto_instrutor:
          "Pos-RCE: monitorizacao completa (PAS >= 90, SpO2 92-98, ETCO2 35-45, ECG 12 derivacoes). Ventilacao: FR 10/min, evitar hiperventilacao, titular FiO2. Labs: gaso, hemograma, eletrolitos, funcao renal, troponina, lactato, glicemia.",
        respostas_esperadas: [
          "Monitorizacao completa",
          "Meta PAS >= 90",
          "Meta SpO2 92-98",
          "Meta ETCO2 35-45",
          "FR 10/min sem hiperventilacao",
          "Solicitar gaso, hemograma, eletrolitos, funcao renal, troponina, lactato e glicemia"
        ],
      ...
      },
      {
        ...
        tipo: "pos_rce",
        texto_instrutor:
          "Neuro: comatoso, indicar controle de temperatura (32 a 37,5) por no minimo 36h; evitar hipertermia; reaquecer <=0,5 C/h. Investigar causa: ECG 12D, IAMCSST => cath emergente; se nao, estrategia seletiva/tardia; RX torax; TC cranio se indicado.",
        respostas_esperadas: [
          "Controle de temperatura 32 a 37,5 por no minimo 36h",
          "Evitar hipertermia",
          "Reaquecer <=0,5 C/h",
          "Investigar causa com ECG 12D, estrategia coronariana, RX torax e TC cranio se indicado"
        ],
      ...
      },
      {
        ...
        tipo: "pos_rce",
        texto_instrutor:
          "Hemodinamica: PA 88/55 => norepinefrina para PAS >= 90. Prognostico: evitar prognosticacao <72h; considerar EEG; transferir UTI.",
        respostas_esperadas: [
          "Iniciar norepinefrina para PAS >= 90",
          "Evitar prognosticacao <72h",
          "Considerar EEG",
          "Transferir UTI"
        ],
        vitals: { fc: 85, pa: "96/62", spo2: 95, etco2: 36, pulso: true },
        waveform: "ritmo_organizado",
        evento: "Fim do cenario",
        ecg_image: null,
        next: null
      }
    ]
